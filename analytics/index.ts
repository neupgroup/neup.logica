...
import { project } from '@neup/logica/analytics/project';
...
export { project };
export { requestAnalyticsApi } from '@neup/logica/analytics/api';
export type {
  AnalyticsApiResponse,
} from '@neup/logica/analytics/api';
export type {
  AnalyticsActivityInput,
  AnalyticsProjectScope,
  PostActivityResponseBody,
} from '@neup/logica/analytics/project';
