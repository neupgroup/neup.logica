...
import { listEstateProperties, type EstatePropertyListResponseBody } from '@neup/logica/estate/property/list';
import type { EstateObjectRecord } from '@neup/logica/estate/types';
